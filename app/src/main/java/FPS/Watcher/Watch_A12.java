...
public class Watch_A12 {
    ...
    public static SurfaceControlFpsListener fpsListener = new SurfaceControlFpsListener() {
        @Override
...
//        sendBinderToAppByStickyBroadcast();
        ...
        Runtime.getRuntime().addShutdownHook(new Thread(Watch_A12::exitFPSWatch));
        Looper.loop();
        exitFPSWatch();
    }
